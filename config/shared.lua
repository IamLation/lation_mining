return {
    ...
    mining = {
        ...
        -- You can add or remove mines as you wish but there must always be one
        -- Be sure to follow the same format as above
        [2] = { -- Example second mine
            -- The center-most coords of the entire mining area
            center = vec3(-879.82, 2818.85, 13.15),
            -- What hours is mining allowed to happen?
            -- By default, it's 24/7, but for example - if you wish to only
            -- Allow mining during the day, set hours = { min = 6, max = 20 }
            hours = { min = 0, max = 24 },
            ...
            zones = {
                [1] = {
                    ...
                    -- The coordinates these ores spawn at
                    ores = {
                        [1] = vec3(-879.82, 2818.85, 13.15),
                        [2] = vec3(-885.82, 2818.85, 13.15),
                        [3] = vec3(-891.82, 2818.85, 13.15),
                        [4] = vec3(-897.82, 2818.85, 13.15),
                        [5] = vec3(-903.82, 2818.85, 13.15),
                        [6] = vec3(-909.82, 2818.85, 13.15),
                        [7] = vec3(-915.82, 2818.85, 13.15),
                    }
                },
                [2] = {
                    models = { 'prop_rock_3_b', 'prop_rock_3_d', 'prop_rock_3_f' },
                    ...
                    respawn = 50000,
                    ores = {
                        [1] = vec3(-865.21, 2780.07, 11.08),
                        [2] = vec3(-869.21, 2780.07, 11.08),
                        [3] = vec3(-873.21, 2780.07, 11.08),
                        [4] = vec3(-877.21, 2780.07, 11.08),
                    }
                }
            }
        },
